...
from mmcls.models.backbones.swin_transformer import (build_norm_layer,SwinBlock,
                                                     SwinBlockSequence,
                                                     SwinTransformer)
...
class SwinBlockAdapterformer(BaseModule):
    ...
    def __init__(self,
        ...
        super(SwinBlockAdapterformer, self).__init__(init_cfg)
...
class SwinBlockSequenceAdapterformer(BaseModule):
    ...
    def __init__(self,
        ...
        for i in range(depth):
            ...
            block = SwinBlockAdapterformer(**_block_cfg)
...
class SwinTransformerAdapterformer(SwinTransformer):
    ...
    def __init__(
        ...
        for i, (depth,
            ...
            stage = SwinBlockSequenceAdapterformer(**_stage_cfg)
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, *args,
        ...
        if (version is None or version < 2) and \
                self.__class__ is SwinTransformerAdapterformer:
