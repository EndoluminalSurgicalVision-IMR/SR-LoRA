"""
BackBone: ViT
PET method: VPT - <<Visual Prompt Tuning>>
Paper: https://link.springer.com/chapter/10.1007/978-3-031-19827-4_41
...
class PromptedVisionTransformer(VisionTransformer):
    ...
    def __init__(self,
        ...
        # self.prompt_layers = list(range(self.num_layers)) if prompt_layers is None else prompt_layers
        prompt = torch.empty(
