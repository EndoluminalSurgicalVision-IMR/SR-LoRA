...
class VitSPU_LoRA(VisionTransformer):
    ...
    def __init__(self,
        ...
        # self.set_rank = lora.Linear.set_rank
        # self.get_dimension = lora.Linear.get_dimension
