...
run_name = f'in21k-vitlora_cpb_bs4_lr{lr}_{dataset}_{sub_dataset}'

model = dict(
    type='ImageClassifier',
    backbone=dict(type='VitCPB',lora_rank=8),
    head=dict(
        type='LinearClsHead',
        num_classes=5, 
        in_channels=768,
...
work_dir = f'work_dirs/vit_lora_cpb-vtab-few-shot/{run_name}'
