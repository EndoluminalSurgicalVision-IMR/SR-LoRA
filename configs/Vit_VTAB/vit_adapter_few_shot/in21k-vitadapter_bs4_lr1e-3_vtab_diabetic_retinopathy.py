...
run_name = f'in21k-vitadapter_bs4_lr{lr}_{dataset}_{sub_dataset}'

model = dict(
    type='ImageClassifier',
    backbone=dict(type='VitAdapter_SOTA'),
    head=dict(
        type='LinearClsHead',
        num_classes=5, 
        in_channels=768,
...
work_dir = f'work_dirs/vit_adapter-vtab-few-shot/{run_name}'
